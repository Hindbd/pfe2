          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input id="date_debut" class="form-control" rows="4" placeholder="YY/MM/DD" name="date_debut">
              </div>
              <div class="form-group">
                <label for="date_fin">Date de fin</label>
                <input id="date_fin" class="form-control" rows="4" placeholder="YY/MM/DD" name="date_fin">
              </div>
            </div>
            <!-- /.card-body -->
          </div>
